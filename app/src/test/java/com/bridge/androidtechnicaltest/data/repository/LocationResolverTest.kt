...
class LocationResolverTest {
    ...
    @Test
    fun getPrettyLocationReturnsCachedLocationWhenWithinRadius() = runTest {
        val lat = 40.7128
        val lng = -74.0060
        val cachedEntity = LocationCacheEntity(
            id = 1,
            latitude = 40.7129,
            longitude = -74.0061,
            cityName = "New York",
    ...
    @Test
    fun getPrettyLocationCallsApiWhenNoCacheHit() = runTest {
        val lat = 40.7128
        val lng = -74.0060
    ...
    @Test
    fun getPrettyLocationCachesApiResult() = runTest {
        val lat = 40.7128
        val lng = -74.0060
        val geocodingResponse = GeocodingResponse(
            name = "New York",
        ...
        assertEquals("New York", cachedEntity.cityName)
    }

    @Test
    fun getPrettyLocationReturnsNullWhenApiReturnsEmptyList() = runTest {
        val lat = 40.7128
        val lng = -74.0060
    ...
    @Test
    fun getPrettyLocationReturnsNullWhenApiCallFails() = runTest {
        val lat = 40.7128
        val lng = -74.0060
    ...
    @Test
    fun getPrettyLocationFallsBackToStateWhenNameIsBlank() = runTest {
        val lat = 40.7128
        val lng = -74.0060
        val geocodingResponse = GeocodingResponse(
            name = "",
    ...
    @Test
    fun getPrettyLocationFallsBackToCountryWhenNameAndStateAreBlank() = runTest {
        val lat = 40.7128
        val lng = -74.0060
        val geocodingResponse = GeocodingResponse(
            name = "",
    ...
    @Test
    fun getPrettyLocationIgnoresCachedLocationOutsideRadius() = runTest {
        val lat = 40.7128
        val lng = -74.0060
        val farCachedEntity = LocationCacheEntity(
            id = 1,
            latitude = 40.8000,
            longitude = -74.1000,
    ...
    @Test
    fun getPrettyLocationHandlesExceptionGracefully() = runTest {
        val lat = 40.7128
        val lng = -74.0060
    ...
    @Test
    fun cleanupOldCacheDeletesOldEntries() = runTest {
    ...
    @Test
    fun cleanupOldCacheHandlesExceptionGracefully() = runTest {
