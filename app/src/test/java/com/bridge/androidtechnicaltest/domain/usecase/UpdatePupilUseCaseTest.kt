...
class UpdatePupilUseCaseTest {
    ...
    @Test
    fun invokeSuccessfullyUpdatesExistingPupil() = runTest {
        ...
        val expectedUpdatedPupil = existingPupil.copy(
            name = "New Name",
            country = "New Country",
            image = "new.jpg",
            latitude = 3.0,
    ...
    @Test
    fun invokePreservesSyncFieldsFromExistingPupil() = runTest {
        val existingPupil = Pupil(
            pupilId = 42,
            name = "Original",
    ...
    @Test
    fun invokeReturnsErrorWhenPupilNotFound() = runTest {
        val updatedEntity = PupilEntity(
            id = 999,
            name = "Non-existent",
            country = "Nowhere",
    ...
    @Test
    fun invokeReturnsErrorWhenRepositoryGetThrowsException() = runTest {
        val updatedEntity = PupilEntity(
            id = 123,
            name = "Test",
    ...
    @Test
    fun invokeReturnsErrorWhenRepositoryUpdateThrowsException() = runTest {
        val existingPupil = Pupil(
            pupilId = 456,
            name = "Existing",
