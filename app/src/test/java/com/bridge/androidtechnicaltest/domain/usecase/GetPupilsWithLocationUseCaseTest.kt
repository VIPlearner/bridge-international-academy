...
class GetPupilsWithLocationUseCaseTest {
    ...
    @Test
    fun invokeReturnsEmptyListWhenRepositoryIsEmpty() =
        runTest {
    ...
    @Test
    fun invokeReturnsPupilsWithResolvedLocations() =
        runTest {
            val pupil1 =
                Pupil(
                    pupilId = 1,
    ...
    @Test
    fun invokeHandlesLocationResolutionFailureGracefully() =
        runTest {
            val pupil =
                Pupil(
                    pupilId = 1,
    ...
    @Test
    fun invokeHandlesLocationResolverExceptionGracefully() =
        runTest {
            val pupil =
                Pupil(
                    pupilId = 1,
    ...
    @Test
    fun invokeMapsAllPupilFieldsCorrectly() =
        runTest {
            val pupil =
                Pupil(
                    pupilId = 42,
    ...
    @Test
    fun invokeCallsLocationResolverForEachPupil() =
        runTest {
            val pupil1 =
                Pupil(
                    pupilId = 1,
