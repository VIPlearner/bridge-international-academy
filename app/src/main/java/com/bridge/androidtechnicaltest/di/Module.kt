...
import com.bridge.androidtechnicaltest.data.datastore.PreferencesManager
...
object DataStoreModule {
    ...
    @Provides
    @Singleton
    fun provideDataStoreRepository(preferencesManager: PreferencesManager): DataStoreRepository {
        return DataStoreRepository(preferencesManager)
    }
}
